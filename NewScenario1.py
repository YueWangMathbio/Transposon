...
"""
Algorithm 1 starts here. Given m permutations of 0, ..., n - 1, the goal is to
find one longest common subsequence. Besides, for each gene i, it finds the 
longest path from i to n - 1 and the longest path from 0 to i.
"""

sequences = [[0, 1, 2, 3, 4, 5, 6, 7],
   [0, 1, 4, 2, 3, 5, 6, 7],
   [0, 1, 2, 4, 3, 6, 5, 7]]
# sequences is the input of m sequences, where each sequence is a permutation 
# of 0, ..., n - 1.
...
# output the final results of Algorithm 2. Notice that 0 and n - 1 are
