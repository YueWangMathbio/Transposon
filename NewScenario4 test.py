# -*- coding: utf-8 -*-
"""
This code tests the performance of Algorithm 6 for Scenario 4 in the paper
...
for curr_gene in sequences[0]: # for each gene copy in the first sequence
    ...
    # add the current gene copy to the subsequence of i, j, curr_gene
print('standard_subseq constructed')
...
while gene_number > 0: # when there is at least one gene left
    print('number of remaining genes: ', gene_number)
...
"""
For dataset 1:
    number of transposons:  196
    number of non-transposons:  400
For dataset 2:
    transposons:  ['dkgB\n', 'metN\n', 'metQ\n', 'rcsF\n', 'prfC\n', 'rimI\n', 
                   'rsmC\n', 'hpaC\n', 'iraD\n', 'fecC\n', 'fecD\n', 'purH\n', 
                   'eutA\n', 'pssA\n']
